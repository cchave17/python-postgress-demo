...
--
-- Notice that the employees table has been aliased as 'e' and the employees_territories
-- table has been aliased as 'et'.
-- 
...
SELECT c.company_name, SUM(od.quantity) AS total_quant 
